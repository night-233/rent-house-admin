...
const SearchFilter = (props) => {
  ...
  const [showSearchType, setShowSearchType] = useState<any>(null);

  const { searchParams, onChange } = props;

  const [priceType, setPriceType] = useState<any>();

  const [priceMinInput, setPriceMinInput] = useState<any>();

  const [priceMaxInput, setPriceMaxInput] = useState<any>();
